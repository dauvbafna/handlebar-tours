...
mongoose.connect('mongodb://handlebars-tours:handlebars-tours@ds155299.mlab.com:55299/moto-tours', {
  ...
  .then(() => {
    ...
    return createNewTour('Nepal Tour: 7 Days', 'some cool description here', fullroute);
  })
  .then(() => {
    ...
    return createNewTour('Grand Alps Tour: 13 Days', 'some cool description here', fullroute);
  })
  .then(() => {
    mongoose.disconnect();
  })
